...
/** Preserves table geometry while server-paginated rows are loading. */
export function TableSkeleton({ rows = 7, columns = 6, label = 'Loading records' }: { rows?: number; columns?: number; label?: string }) {
