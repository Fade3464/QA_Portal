...
export function AdministrationPage() {
  ...
  useEffect(() => {
    ...
    else form.setFieldsValue({ is_active: true, must_change_password: true, timezone: 'Asia/Karachi', request_timeout_seconds: 15, api_source: 'qa_portal', avatar: 'groups' });
  }, [editor, form]);
