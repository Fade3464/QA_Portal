...
export function ForgotPasswordPage() {
  ...
  return <AuthCard>
    <div className="simple-auth__heading"><Title level={2} className="auth-form-title">Reset your password</Title></div>
...
export function ResetPasswordPage() {
  ...
  return <AuthCard>
    <div className="simple-auth__heading"><Title level={2} className="auth-form-title">Choose a new password</Title></div>
    {error && <Alert className="auth-alert" type="error" title={error} showIcon />}
...
export function ChangePasswordPage() {
  ...
  return <AuthCard>
    <div className="simple-auth__heading"><Title level={2} className="auth-form-title">Change password</Title></div>
    {error && <Alert className="auth-alert" type="error" title={error} showIcon />}
